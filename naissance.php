...
<head>
    ...
    <title>Bouquets de naissance</title>
...
<body>
    ...
    <main>
        <?php include 'hero_naissance.php'; ?>
        <?php
         require 'db.php';                /*le require au lieu de include permet de s'assurer que le fichier est bien inclus, sinon le script s'arrête  ce qui est une bonne pratique pour les fichiers essentiels*/
            $sql = "SELECT * FROM produits WHERE categorie_id IN (1, 2) ORDER BY nom ASC "; // Requête pour récupérer tous les produits mise dans la variable $sql parce que je peux l'utiliser plusieurs fois et que c'est plus lisible et je peux la modifier facilement si besoin
        ...
        <section class="fleurs-section">
            <h1>Célébrez une nouvelle vie avec des fleurs</h1>
