...
<body>
    ...
    <main>
        <?php include 'hero_roses_classiques.php'; ?>
        <?php
         require 'db.php';                /*le require au lieu de include permet de s'assurer que le fichier est bien inclus, sinon le script s'arrête  ce qui est une bonne pratique pour les fichiers essentiels*/
            $sql = "SELECT * FROM produits WHERE image_url LIKE '%_rc.jpg'"; // Requête pour récupérer tous les produits mise dans la variable $sql parce que je peux l'utiliser plusieurs fois et que c'est plus lisible et je peux la modifier facilement si besoin
